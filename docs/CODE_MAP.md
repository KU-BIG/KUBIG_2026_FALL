...
| 실험 A: quantity 축, GEX-ATAC(multiome) 확장 (계획서 외 후속) | `src/experiments/phase2_expA_multiome_quantity.py` | **실행완료** | 결과: `results/tables/phase2_expA_multiome_quantity.csv`. **cite와 거의 동일한 패턴 재현** (예: n=2,000 gap 0.084 vs 0.090) — quantity 축 발견이 GEX-ADT 한정이 아님을 확인. docs/HISTORY.md 2026-08-13(계속 9) |
